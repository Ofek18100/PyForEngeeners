...
def testSingleCase(student_func, case_args, case_expected) -> tuple:
    ...
    try:
        ...
        signal.alarm(5)  # Make sure there are no infinite loops
...
def testQ1(student_func, err_code):
    ...
    expected = [1, 3, 4, 4774621056131303]
