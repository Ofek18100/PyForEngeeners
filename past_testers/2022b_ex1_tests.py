...
def testQ3(student_code, err_code):
    ...
    expected_outputs = ['I am 13 and I am divisible by 13',
                        'I am 0 and I am divisible by 13',
                        'I am -1 and I cannot be divided by 13',
                        'I am 82 and I cannot be divided by 13']
...
def testQ5(student_code, err_code):
    ...
    expected_outputs = ['Error: not a legal input!',
                        'Error: not a legal input!',
                        'Error: not a legal input!',
                        ' VoldemortLord',
                        'Lord Voldemort']
