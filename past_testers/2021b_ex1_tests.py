...
def general_ex1_tester(expected, student_output):
    ...
    '''
    if (numRes == False) or (textRes == False and editDistance > 2):
...
def testQ3(student_code, err_code):
    ...
    expected_outputs = ['I am 9 and I am divisible by 9',
                        'I am 0 and I am divisible by 9',
                        'I am -1 and I am not divisible by 9',
                        'I am 82 and I am not divisible by 9']
